...
**받음**(`art/source-river.png`, 1792×597): 오른쪽 ✦ 170px을 잘라내고 양끝 160px을 서로 섞어 이어붙여도 무늬가 맞게 만든 뒤 1400px 폭 `art/river.webp`(55KB). `.water` 배경으로 깔고 90초에 한 폭씩 왼쪽으로 흐른다. 위쪽은 짙은 색을 덧씌우고 아래로 사라진다. 등불 반사(box-reflect)는 그대로 위에 얹힌다.
